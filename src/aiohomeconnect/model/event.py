...
class EventKey(StrEnum):
    ...
    BSH_COMMON_EVENT_CURRENT_STEP_REMAINING_TIME = (
    ...
    DISHCARE_DISHWASHER_PRETREATMENT = OptionKey.DISHCARE_DISHWASHER_PRETREATMENT
    DISHCARE_DISHWASHER_SANITATION_UC = OptionKey.DISHCARE_DISHWASHER_SANITATION_UC
