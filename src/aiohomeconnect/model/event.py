...
class EventKey(StrEnum):
    ...
    BSH_COMMON_EVENT_FAVORITE_001_EXTERNAL_TRIGGER = (
        "BSH.Common.Event.Favorite.001.ExternalTrigger"
    )
    BSH_COMMON_EVENT_FAVORITE_002_EXTERNAL_TRIGGER = (
        "BSH.Common.Event.Favorite.002.ExternalTrigger"
    )
    ...
    BSH_COMMON_OPTION_BASE_PROGRAM = OptionKey.BSH_COMMON_BASE_PROGRAM
    BSH_COMMON_OPTION_CURRENT_STEP_REMAINING_TIME = (
        OptionKey.BSH_COMMON_CURRENT_STEP_REMAINING_TIME
    )
    ...
    BSH_COMMON_OPTION_PROGRAM_NAME = OptionKey.BSH_COMMON_PROGRAM_NAME
    ...
    BSH_COMMON_OPTION_REMAINING_PROGRAM_TIME_AUTO_COUNTING = (
        OptionKey.BSH_COMMON_REMAINING_PROGRAM_TIME_AUTO_COUNTING
    )
    BSH_COMMON_OPTION_REMAINING_PROGRAM_TIME_ESTIMATION_STATE = (
        OptionKey.BSH_COMMON_REMAINING_PROGRAM_TIME_ESTIMATION_STATE
    )
    BSH_COMMON_OPTION_REMAINING_PROGRAM_TIME_IS_ESTIMATED = (
        OptionKey.BSH_COMMON_REMAINING_PROGRAM_TIME_IS_ESTIMATED
    )
    BSH_COMMON_OPTION_SMART_ENERGY_SERVICE_SMART_START_ENABLED = (
    ...
    CONSUMER_PRODUCTS_COFFEE_MAKER_OPTION_AROMA_SELECT = (
        OptionKey.CONSUMER_PRODUCTS_COFFEE_MAKER_AROMA_SELECT
    )
    ...
    CONSUMER_PRODUCTS_COFFEE_MAKER_OPTION_BEVERAGE_SIZE = (
        OptionKey.CONSUMER_PRODUCTS_COFFEE_MAKER_BEVERAGE_SIZE
    )
    CONSUMER_PRODUCTS_COFFEE_MAKER_OPTION_BEVERAGES_REMAINING = (
        OptionKey.CONSUMER_PRODUCTS_COFFEE_MAKER_BEVERAGES_REMAINING
    )
    CONSUMER_PRODUCTS_COFFEE_MAKER_OPTION_COARSNESS = (
        OptionKey.CONSUMER_PRODUCTS_COFFEE_MAKER_COARSNESS
    )
    CONSUMER_PRODUCTS_COFFEE_MAKER_OPTION_COARSNESS_RECOMMENDATION = (
        OptionKey.CONSUMER_PRODUCTS_COFFEE_MAKER_COARSNESS_RECOMMENDATION
    )
    CONSUMER_PRODUCTS_COFFEE_MAKER_OPTION_COFFEE_MILK_RATIO = (
        OptionKey.CONSUMER_PRODUCTS_COFFEE_MAKER_COFFEE_MILK_RATIO
    )
    CONSUMER_PRODUCTS_COFFEE_MAKER_OPTION_COFFEE_STRENGTH = (
        OptionKey.CONSUMER_PRODUCTS_COFFEE_MAKER_COFFEE_STRENGTH
    )
    CONSUMER_PRODUCTS_COFFEE_MAKER_OPTION_COFFEE_STRENGTH_RECOMMENDATION = (
        OptionKey.CONSUMER_PRODUCTS_COFFEE_MAKER_COFFEE_STRENGTH_RECOMMENDATION
    )
    CONSUMER_PRODUCTS_COFFEE_MAKER_OPTION_COFFEE_TEMPERATURE = (
        OptionKey.CONSUMER_PRODUCTS_COFFEE_MAKER_COFFEE_TEMPERATURE
    )
    CONSUMER_PRODUCTS_COFFEE_MAKER_OPTION_COFFEE_TEMPERATURE_RECOMMENDATION = (
        OptionKey.CONSUMER_PRODUCTS_COFFEE_MAKER_COFFEE_TEMPERATURE_RECOMMENDATION
    )
    CONSUMER_PRODUCTS_COFFEE_MAKER_OPTION_FILL_QUANTITY = (
        OptionKey.CONSUMER_PRODUCTS_COFFEE_MAKER_FILL_QUANTITY
    )
    CONSUMER_PRODUCTS_COFFEE_MAKER_OPTION_FILL_QUANTITY_RECOMMENDATION = (
        OptionKey.CONSUMER_PRODUCTS_COFFEE_MAKER_FILL_QUANTITY_RECOMMENDATION
    )
    CONSUMER_PRODUCTS_COFFEE_MAKER_OPTION_FLOW_RATE = (
        OptionKey.CONSUMER_PRODUCTS_COFFEE_MAKER_FLOW_RATE
    )
    CONSUMER_PRODUCTS_COFFEE_MAKER_OPTION_FLOW_RATE_RECOMMENDATION = (
        OptionKey.CONSUMER_PRODUCTS_COFFEE_MAKER_FLOW_RATE_RECOMMENDATION
    )
    ...
    CONSUMER_PRODUCTS_COFFEE_MAKER_OPTION_SHOT_COUNT = (
        OptionKey.CONSUMER_PRODUCTS_COFFEE_MAKER_SHOT_COUNT
    )
    ...
    COOKING_COMMON_OPTION_HOOD_BOOST = OptionKey.COOKING_COMMON_HOOD_BOOST
    ...
    COOKING_OVEN_OPTION_AIR_EXCHANGE = OptionKey.COOKING_OVEN_AIR_EXCHANGE
    COOKING_OVEN_OPTION_CAVITY_SELECTOR = OptionKey.COOKING_OVEN_CAVITY_SELECTOR
    COOKING_OVEN_OPTION_FAST_PRE_HEAT = OptionKey.COOKING_OVEN_FAST_PRE_HEAT
    COOKING_OVEN_OPTION_HEATUP_PROGRESS = OptionKey.COOKING_OVEN_HEATUP_PROGRESS
    COOKING_OVEN_OPTION_LEVEL = OptionKey.COOKING_OVEN_LEVEL
    COOKING_OVEN_OPTION_MEAT_PROBE_TEMPERATURE_V2 = (
        OptionKey.COOKING_OVEN_MEAT_PROBE_TEMPERATURE_V2
    )
    COOKING_OVEN_OPTION_MICROWAVE_POWER = OptionKey.COOKING_OVEN_MICROWAVE_POWER
    COOKING_OVEN_OPTION_PYROLYSIS_LEVEL = OptionKey.COOKING_OVEN_PYROLYSIS_LEVEL
    COOKING_OVEN_OPTION_SETPOINT_TEMPERATURE = (
        OptionKey.COOKING_OVEN_SETPOINT_TEMPERATURE
    )
    COOKING_OVEN_OPTION_STEAM_ASSIST_LEVEL = OptionKey.COOKING_OVEN_STEAM_ASSIST_LEVEL
    COOKING_OVEN_OPTION_STEAM_BOOST = OptionKey.COOKING_OVEN_STEAM_BOOST
    ...
    DISHCARE_DISHWASHER_EVENT_MACHINE_CARE_AND_FILTER_CLEANING_REMINDER = (
        "Dishcare.Dishwasher.Event.MachineCareAndFilterCleaningReminder"
    )
    DISHCARE_DISHWASHER_EVENT_MACHINE_CARE_AND_LOW_MAINTENANCE_FILTER_CLEANING_REMINDER = (  # noqa: E501
        "Dishcare.Dishwasher.Event.MachineCareAndLowMaintenanceFilterCleaningReminder"
    )
    DISHCARE_DISHWASHER_EVENT_MACHINE_CARE_REMINDER = (
        "Dishcare.Dishwasher.Event.MachineCareReminder"
    )
    DISHCARE_DISHWASHER_EVENT_PROGRAM_BLOCKED_SALT_LACK = (
        "Dishcare.Dishwasher.Event.ProgramBlockedSaltLack"
    )
    DISHCARE_DISHWASHER_EVENT_RINSE_AID_LACK = "Dishcare.Dishwasher.Event.RinseAidLack"
    DISHCARE_DISHWASHER_EVENT_RINSE_AID_NEARLY_EMPTY = (
        "Dishcare.Dishwasher.Event.RinseAidNearlyEmpty"
    )
    DISHCARE_DISHWASHER_EVENT_SALT_LACK = "Dishcare.Dishwasher.Event.SaltLack"
    DISHCARE_DISHWASHER_EVENT_SALT_NEARLY_EMPTY = (
        "Dishcare.Dishwasher.Event.SaltNearlyEmpty"
    )
    DISHCARE_DISHWASHER_EVENT_SMART_FILTER_CLEANING_REMINDER = (
    ...
    DISHCARE_DISHWASHER_OPTION_DELICATE_BASKET = (
        OptionKey.DISHCARE_DISHWASHER_DELICATE_BASKET
    )
    DISHCARE_DISHWASHER_OPTION_ECO_DRY = OptionKey.DISHCARE_DISHWASHER_ECO_DRY
    DISHCARE_DISHWASHER_OPTION_ENERGY_SAFE = OptionKey.DISHCARE_DISHWASHER_ENERGY_SAFE
    DISHCARE_DISHWASHER_OPTION_EXTRA_DRY = OptionKey.DISHCARE_DISHWASHER_EXTRA_DRY
    DISHCARE_DISHWASHER_OPTION_EXTRA_RINSE = OptionKey.DISHCARE_DISHWASHER_EXTRA_RINSE
    DISHCARE_DISHWASHER_OPTION_FLEX_SPRAY_BACK_LEFT = (
        OptionKey.DISHCARE_DISHWASHER_FLEX_SPRAY_BACK_LEFT
    )
    DISHCARE_DISHWASHER_OPTION_FLEX_SPRAY_BACK_RIGHT = (
        OptionKey.DISHCARE_DISHWASHER_FLEX_SPRAY_BACK_RIGHT
    )
    DISHCARE_DISHWASHER_OPTION_FLEX_SPRAY_FRONT_LEFT = (
        OptionKey.DISHCARE_DISHWASHER_FLEX_SPRAY_FRONT_LEFT
    )
    DISHCARE_DISHWASHER_OPTION_FLEX_SPRAY_FRONT_RIGHT = (
        OptionKey.DISHCARE_DISHWASHER_FLEX_SPRAY_FRONT_RIGHT
    )
    DISHCARE_DISHWASHER_OPTION_FLEX_SPRAY_TYPE = (
        OptionKey.DISHCARE_DISHWASHER_FLEX_SPRAY_TYPE
    )
    DISHCARE_DISHWASHER_OPTION_HALF_LOAD = OptionKey.DISHCARE_DISHWASHER_HALF_LOAD
    DISHCARE_DISHWASHER_OPTION_HOLIDAY_MODE = OptionKey.DISHCARE_DISHWASHER_HOLIDAY_MODE
    ...
    DISHCARE_DISHWASHER_OPTION_LEARNING_DISHWASHER_CLEANING_LEVEL = (
        OptionKey.DISHCARE_DISHWASHER_LEARNING_DISHWASHER_CLEANING_LEVEL
    )
    DISHCARE_DISHWASHER_OPTION_LEARNING_DISHWASHER_DRYING_LEVEL = (
        OptionKey.DISHCARE_DISHWASHER_LEARNING_DISHWASHER_DRYING_LEVEL
    )
    DISHCARE_DISHWASHER_OPTION_LEARNING_DISHWASHER_DURATION_LEVEL = (
        OptionKey.DISHCARE_DISHWASHER_LEARNING_DISHWASHER_DURATION_LEVEL
    )
    DISHCARE_DISHWASHER_OPTION_PRETREATMENT = OptionKey.DISHCARE_DISHWASHER_PRETREATMENT
    DISHCARE_DISHWASHER_OPTION_SANITATION_UC = (
        OptionKey.DISHCARE_DISHWASHER_SANITATION_UC
    )
    DISHCARE_DISHWASHER_OPTION_SILENCE_ON_DEMAND = (
        OptionKey.DISHCARE_DISHWASHER_SILENCE_ON_DEMAND
    )
    DISHCARE_DISHWASHER_OPTION_STORAGE_FUNCTION = (
        OptionKey.DISHCARE_DISHWASHER_STORAGE_FUNCTION
    )
    DISHCARE_DISHWASHER_OPTION_TURBO = OptionKey.DISHCARE_DISHWASHER_TURBO
    DISHCARE_DISHWASHER_OPTION_VARIO_SPEED = OptionKey.DISHCARE_DISHWASHER_VARIO_SPEED
    ...
    HEATING_VENTILATION_AIR_CONDITIONING_AIR_CONDITIONER_OPTION_SETPOINT_TEMPERATURE = (
        OptionKey.HEATING_VENTILATION_AIR_CONDITIONING_AIR_CONDITIONER_SETPOINT_TEMPERATURE  # noqa: E501, RUF100
    )
    LAUNDRY_CARE_COMMON_OPTION_LOAD_RECOMMENDATION = (
        OptionKey.LAUNDRY_CARE_COMMON_LOAD_RECOMMENDATION
    )
    LAUNDRY_CARE_COMMON_OPTION_LOW_TEMPERATURE_HYGIENE = (
        OptionKey.LAUNDRY_CARE_COMMON_LOW_TEMPERATURE_HYGIENE
    )
    LAUNDRY_CARE_COMMON_OPTION_PROCESS_PHASE = (
        OptionKey.LAUNDRY_CARE_COMMON_PROCESS_PHASE
    )
    LAUNDRY_CARE_COMMON_OPTION_REFER_TO_PROGRAM = (
        OptionKey.LAUNDRY_CARE_COMMON_REFER_TO_PROGRAM
    )
    LAUNDRY_CARE_COMMON_OPTION_SILENT_MODE = OptionKey.LAUNDRY_CARE_COMMON_SILENT_MODE
    LAUNDRY_CARE_COMMON_OPTION_SPEED_PERFECT = (
        OptionKey.LAUNDRY_CARE_COMMON_SPEED_PERFECT
    )
    ...
    LAUNDRY_CARE_DRYER_OPTION_CONNECTED_DRY_ORIGINAL_PROGRAM_TIME = (
        OptionKey.LAUNDRY_CARE_DRYER_CONNECTED_DRY_ORIGINAL_PROGRAM_TIME
    )
    LAUNDRY_CARE_DRYER_OPTION_DRYING_TARGET = OptionKey.LAUNDRY_CARE_DRYER_DRYING_TARGET
    LAUNDRY_CARE_DRYER_OPTION_DRYING_TARGET_ADJUSTMENT = (
        OptionKey.LAUNDRY_CARE_DRYER_DRYING_TARGET_ADJUSTMENT
    )
    LAUNDRY_CARE_DRYER_OPTION_GENTLE = OptionKey.LAUNDRY_CARE_DRYER_GENTLE
    LAUNDRY_CARE_DRYER_OPTION_HALF_LOAD = OptionKey.LAUNDRY_CARE_DRYER_HALF_LOAD
    LAUNDRY_CARE_DRYER_OPTION_PROCESS_PHASE = OptionKey.LAUNDRY_CARE_DRYER_PROCESS_PHASE
    LAUNDRY_CARE_DRYER_OPTION_REFRESHER = OptionKey.LAUNDRY_CARE_DRYER_REFRESHER
    LAUNDRY_CARE_DRYER_OPTION_WRINKLE_GUARD = OptionKey.LAUNDRY_CARE_DRYER_WRINKLE_GUARD
    ...
    LAUNDRY_CARE_WASHER_OPTION_EISA = OptionKey.LAUNDRY_CARE_WASHER_EISA
    LAUNDRY_CARE_WASHER_OPTION_I_DOS_1_ACTIVE_ = (
        OptionKey.LAUNDRY_CARE_WASHER_I_DOS_1_ACTIVE_
    )
    LAUNDRY_CARE_WASHER_OPTION_I_DOS_1_ACTIVE = (
        OptionKey.LAUNDRY_CARE_WASHER_I_DOS_1_ACTIVE
    )
    LAUNDRY_CARE_WASHER_OPTION_I_DOS_1_DOSING_LEVEL = (
        OptionKey.LAUNDRY_CARE_WASHER_I_DOS_1_DOSING_LEVEL
    )
    LAUNDRY_CARE_WASHER_OPTION_I_DOS_2_ACTIVE_ = (
        OptionKey.LAUNDRY_CARE_WASHER_I_DOS_2_ACTIVE_
    )
    LAUNDRY_CARE_WASHER_OPTION_I_DOS_2_ACTIVE = (
        OptionKey.LAUNDRY_CARE_WASHER_I_DOS_2_ACTIVE
    )
    LAUNDRY_CARE_WASHER_OPTION_I_DOS_2_DOSING_LEVEL = (
        OptionKey.LAUNDRY_CARE_WASHER_I_DOS_2_DOSING_LEVEL
    )
    ...
    LAUNDRY_CARE_WASHER_OPTION_MULTIPLE_SOAK = (
        OptionKey.LAUNDRY_CARE_WASHER_MULTIPLE_SOAK
    )
    LAUNDRY_CARE_WASHER_OPTION_PREWASH = OptionKey.LAUNDRY_CARE_WASHER_PREWASH
    LAUNDRY_CARE_WASHER_OPTION_PROCESS_PHASE = (
        OptionKey.LAUNDRY_CARE_WASHER_PROCESS_PHASE
    )
    ...
    LAUNDRY_CARE_WASHER_OPTION_RINSE_PLUS_1 = OptionKey.LAUNDRY_CARE_WASHER_RINSE_PLUS_1
    LAUNDRY_CARE_WASHER_OPTION_SILENT_WASH = OptionKey.LAUNDRY_CARE_WASHER_SILENT_WASH
    LAUNDRY_CARE_WASHER_OPTION_SOAK = OptionKey.LAUNDRY_CARE_WASHER_SOAK
    LAUNDRY_CARE_WASHER_OPTION_SPEED_PERFECT = (
        OptionKey.LAUNDRY_CARE_WASHER_SPEED_PERFECT
    )
    ...
    LAUNDRY_CARE_WASHER_OPTION_WATER_AND_RINSE_PLUS_1 = (
        OptionKey.LAUNDRY_CARE_WASHER_WATER_AND_RINSE_PLUS_1
    )
    ...
    LAUNDRY_CARE_WASHER_OPTION_DRYING_TARGET = (
        OptionKey.LAUNDRY_CARE_WASHER_DRYING_TARGET
    )
    LAUNDRY_CARE_WASHER_OPTION_LOW_TEMPERATURE_HYGIENE = (
        OptionKey.LAUNDRY_CARE_WASHER_LOW_TEMPERATURE_HYGIENE
    )
    LAUNDRY_CARE_WASHER_DRYER_OPTION_DRYER_PROGRAM_MODE = (
        OptionKey.LAUNDRY_CARE_WASHER_DRYER_PROGRAM_MODE
    )
    LAUNDRY_CARE_WASHER_DRYER_OPTION_PROGRAM_MODE = (
        OptionKey.LAUNDRY_CARE_WASHER_DRYER_PROGRAM_MODE
    )
    LAUNDRY_CARE_WASHER_DRYER_OPTION_DRYER_WRINKLE_GUARD_BOOST = (
        OptionKey.LAUNDRY_CARE_WASHER_DRYER_WRINKLE_GUARD_BOOST
    )
